...
@Component({
  ...
  imports: [
    ...
    RouterLink,
    ButtonModule,
    FeatureColorCardComponent,
    RevealOnScrollDirective,
    DownBandComponent,
    DownFlipCardComponent,
    JourneyLikeDownSectionComponent,
    AutismBandComponent,
    OurStoriesComponent,
  ],
...
export class HomeComponent {
  cards = [
    ...
    {
      title: 'قسم الدعم النفسي',
  desc: 'دعم للأسرة وروتين يومي عملي + توازن نفسي للأم: ربط “عجلة الحياة” بمنازل الروح السبعة', 
      badge: 'اتزان',
...

    {
      ...
      desc: 'فع وعي الأم صحيًا بحالة طفلها',
      badge: 'وعي',
      icon: 'pi pi-compass',
      link: '/cards/health-support',
      from: '#14B8A6',
      to: '#22C55E',
...

    {
      ...
      desc: 'مساعدة الأم على بناء نظام غذائي داعم لصحة الطفل وتركيزه ومناعته',
      badge: 'تثقيف',
      icon: 'pi pi-sparkles',
    ...
    },
    {
      ...
      desc: 'تمكين الام من تعليم طفلها في البيت ,اكتشاف مواهبه, تنمية قدراته',
      badge: 'قياس',
